<footer class="page-footer black">
    ...
    <div id="modal1" class="modal black">
        <div class="modal-content yellow-text">
            <h4>Admin Panel</h4>
            
            <form class="col s12">
                <div class="row">
                  <div class="input-field col s12">
                    <input id="email" type="email" class="white-text validate" data-error="Wrong" required>
                    <label class="yellow-text text-lighten-3" for="email">Email</label>
                  </div>
                </div>

              <div class="row">
                <div class="input-field col s12">
                  <input id="password" type="password" class="white-text validate" data-error="Wrong" required>
                  <label class="yellow-text text-lighten-3" for="password">Password</label>
                </div>
              </div>
            </form>
  </div>
